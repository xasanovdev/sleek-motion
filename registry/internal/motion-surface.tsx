...
export function MotionSurface({ as = "div", ...props }: { as?: AnimationTag; [key: string]: unknown }) {
  const present = useIsPresent();
  const Element = motion[as] as ElementType;
  return <Element {...props} inert={!present || props.inert || undefined} aria-hidden={!present ? true : props["aria-hidden"]} />;
}
